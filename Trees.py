...
res = np.zeros((len(max_features), len(max_depth)))
k=0
for mf in max_features:
    k1=0
    for j in max_depth:
        clf = DecisionTreeClassifier(max_depth=j, max_features=mf)
...
plt.plot(max_depth ,res[0], label = '2 features', color = 'salmon')
plt.plot(max_depth ,res[1], label = '3 features', color = 'skyblue')
plt.plot(max_depth ,res[2], label = '4 features', color = 'green')
plt.plot(max_depth ,res[3], label = '5 features', color = 'brown')
plt.plot(max_depth ,res[4], label = '6 features', color = 'grey')
plt.plot(max_depth ,res[5], label = '7 features', color = 'red')
plt.title("Selection of parameters")
plt.legend()
...
tree_params = {'max_depth': range(1,30), 'max_features': range(4,7)}
...
clf = DecisionTreeClassifier(max_depth=14, max_features=5)
